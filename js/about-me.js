  ...
  return `
    <div class="top-section">
      <div class="info-tab">
        ...
        <svg class="close-button" viewBox="0 0 11 10" aria-hidden="true"><use href="img/icons.svg#icon-close"/></svg>
      </div>
  ...
  fetch(`https://api.github.com/gists/${gistIdentifier}`)
    ...
    .then((data) => {
        ...
        <div class="right-section">
          <div class="details-section">
            <div class="info-icons">
              <svg id="gist${
                index + 1
              }-description-icon" class="description-icon" viewBox="0 0 15 16" aria-hidden="true"><use href="img/icons.svg#icon-description"/></svg>
              <span id="gist${
                index + 1
      ...
      descriptionElement.insertAdjacentHTML(
        ...
        `<svg id="gist${
          index + 1
        }-close-button" class="description-close-button" viewBox="0 0 11 10" aria-hidden="true"><use href="img/icons.svg#icon-close"/></svg>`
      );
    })
);
